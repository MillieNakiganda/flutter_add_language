...
/// A custom set of date patterns for the `cy` locale.
///
...
/// A custom set of date symbols for the `cy` locale.
///
...
// #docregion Delegate
class _CyMaterialLocalizationsDelegate
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    ...
    // The locale (in this case `cy`) needs to be initialized into the custom
    // date symbols and patterns setup that Flutter uses.
    date_symbol_data_custom.initializeDateFormattingCustom(
      locale: localeName,
      patterns: cyLocaleDatePatterns,
      symbols: intl.DateSymbols.deserializeFromMap(cyDateSymbols),
    );
    ...
    return SynchronousFuture<MaterialLocalizations>(
      CyMaterialLocalizations(
        ...
        // for 'en_US' instead.
        decimalFormat: intl.NumberFormat('#,##0.###', 'en_GB'),
        twoDigitZeroPaddedFormat: intl.NumberFormat('00', 'en_GB'),
...
/// A custom set of localizations for the 'cy' locale. In this example, only
...
// #enddocregion Raw
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate =
      _CyMaterialLocalizationsDelegate();
